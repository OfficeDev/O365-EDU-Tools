...
Once the ADF and storage accounts are created under stonerostersds, create a container named as refcodes to import refCodes.csv used for subject in classes.
