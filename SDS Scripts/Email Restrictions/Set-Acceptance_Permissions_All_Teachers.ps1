...
.Example
PS> .\Set-Acceptance_Permissions_All_Teachers.ps1
...
4. Ensure that you have a security group called "All_Teachers" in Azure Active Directory.
...
catch
{
    ...
    Get-Help -Name .\Set-Acceptance_Permissions_All_Teachers.ps1 -Full | Out-String | Write-Error
    throw
}
