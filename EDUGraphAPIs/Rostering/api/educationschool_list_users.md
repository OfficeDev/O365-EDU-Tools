...
Retrieve a list of educationuser objects.
## Permissions
...
<!-- { "blockType": "ignored" } -->
```http
GET /education/schools/users
GET /education/me/schools/users
GET /education/users/schools/users
```
...
```http
GET https://graph.microsoft.com/beta/education/schools/users
```
##### Response
