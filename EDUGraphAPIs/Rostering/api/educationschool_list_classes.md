...
<!-- { "blockType": "ignored" } -->
```http
GET /education/schools/classes
GET /education/me/schools/classes
GET /education/users/schools/classes
```
...
```http
GET https://graph.microsoft.com/beta/education/schools/classes
```
##### Response
