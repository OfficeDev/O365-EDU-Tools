...
<!-- { "blockType": "ignored" } -->
```http
POST /education/schools/classes
POST /education/me/schools/classes
POST /education/users/schools/classes
...
```http
POST https://graph.microsoft.com/beta/education/schools/classes
