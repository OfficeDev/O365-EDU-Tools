...
<!-- { "blockType": "ignored" } -->
```http
POST /education/schools/users
POST /education/me/schools/users
POST /education/users/schools/users
...
```http
POST https://graph.microsoft.com/beta/education/schools/users
