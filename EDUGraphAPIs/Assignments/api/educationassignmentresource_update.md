...
## Response
If successful, this method returns a `200 OK` response code and updated [educationAssignmentResource](../resources/educationassignmentresource.md) object in the response body.
## Example
##### Request
